...
namespace Cozyheim.LevelingSystem
{
    internal class SkillEitr : SkillBase
    {
        ...
        public SkillEitr(int maxLevel, float bonusPerLevel, string iconName, string displayName, string unit = "") : base(maxLevel, bonusPerLevel, iconName, displayName, unit)
        {
