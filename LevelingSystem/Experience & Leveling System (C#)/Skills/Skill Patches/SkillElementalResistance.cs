...
namespace Cozyheim.LevelingSystem
{
    internal class SkillElementalResistance : SkillBase
    {
        ...
        public SkillElementalResistance(int maxLevel, float bonusPerLevel, string iconName, string displayName, string unit = "") : base(maxLevel, bonusPerLevel, iconName, displayName, unit)
        {
